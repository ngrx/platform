...
describe('EntityEffects (marble testing)', () => {
  ...
  it(
    'should return a QUERY_ALL_SUCCESS with the heroes on success',
    marbles(m => {
      ...
      const response = m.cold('---a|', { a: heroes });
      const expected = m.cold('----b', { b: completion });
      dataService.getAll.and.returnValue(response);

      m.expect(effects.persist$).toBeObservable(expected);
    })
  );

  it(
    'should return a QUERY_ALL_ERROR when data service fails',
    marbles(m => {
      const action = entityActionFactory.create('Hero', EntityOp.QUERY_ALL);
  ...
  it(
    'should return a QUERY_BY_KEY_SUCCESS with a hero on success',
    marbles(m => {
      ...
      actions = m.hot('-a---', { a: action });
      // delay the response 3 frames
      const response = m.cold('---a|', { a: hero });
      const expected = m.cold('----b', { b: completion });
  ...
  it(
    'should return a QUERY_BY_KEY_ERROR when data service fails',
    marbles(m => {
      const action = entityActionFactory.create(
        'Hero',
        EntityOp.QUERY_BY_KEY,
  ...
  it(
    'should return a QUERY_MANY_SUCCESS with selected heroes on success',
    marbles(m => {
  ...
  it(
    'should return a QUERY_MANY_ERROR when data service fails',
    marbles(m => {
      const action = entityActionFactory.create('Hero', EntityOp.QUERY_MANY, {
        name: 'B',
      });
  ...
  it(
    'should return a SAVE_ADD_ONE_SUCCESS (optimistic) with the hero on success',
    marbles(m => {
      const hero = { id: 1, name: 'A' } as Hero;
  ...
  it(
    'should return a SAVE_ADD_ONE_SUCCESS (pessimistic) with the hero on success',
    marbles(m => {
      const hero = { id: 1, name: 'A' } as Hero;
  ...
  it(
    'should return a SAVE_ADD_ONE_ERROR when data service fails',
    marbles(m => {
      const hero = { id: 1, name: 'A' } as Hero;
      const action = entityActionFactory.create(
        'Hero',
  ...
  it(
    'should return a SAVE_DELETE_ONE_SUCCESS (Optimistic) with the delete id on success',
    marbles(m => {
      const action = entityActionFactory.create(
        'Hero',
  ...
  it(
    'should return a SAVE_DELETE_ONE_SUCCESS (Pessimistic) on success',
    marbles(m => {
      const action = entityActionFactory.create(
        'Hero',
        EntityOp.SAVE_DELETE_ONE,
  ...
  it(
    'should return a SAVE_DELETE_ONE_ERROR when data service fails',
    marbles(m => {
      const action = entityActionFactory.create(
        'Hero',
        EntityOp.SAVE_DELETE_ONE,
  ...
  it(
    'should return a SAVE_UPDATE_ONE_SUCCESS (Optimistic) with the hero on success',
    marbles(m => {
      ...
      actions = m.hot('-a---', { a: action });
      // delay the response 3 frames
      const response = m.cold('---a|', { a: updateEntity });
      const expected = m.cold('----b', { b: completion });
  ...
  it(
    'should return a SAVE_UPDATE_ONE_SUCCESS (Pessimistic) with the hero on success',
    marbles(m => {
      const updateEntity = { id: 1, name: 'A' };
      const update = { id: 1, changes: updateEntity } as Update<Hero>;
      const updateResponse = { ...update, changed: true };
  ...
  it(
    'should return a SAVE_UPDATE_ONE_ERROR when data service fails',
    marbles(m => {
  ...
  it(
    'should return a SAVE_UPSERT_ONE_SUCCESS (optimistic) with the hero on success',
    marbles(m => {
      const hero = { id: 1, name: 'A' } as Hero;
  ...
  it(
    'should return a SAVE_UPSERT_ONE_SUCCESS (pessimistic) with the hero on success',
    marbles(m => {
      const hero = { id: 1, name: 'A' } as Hero;
  ...
  it(
    'should return a SAVE_UPSERT_ONE_ERROR when data service fails',
    marbles(m => {
      const hero = { id: 1, name: 'A' } as Hero;
      const action = entityActionFactory.create(
        'Hero',
  ...
  it(
    `should not do anything with an irrelevant action`,
    marbles(m => {
