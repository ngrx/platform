 ...
 *
 * @param seed - optional seed for reproducible time-part
 *
 * @public
 */
...
/**
 * Compares two GUIDs (or other strings) by their last 12 characters.
 * This is useful for sorting GUIDs generated by getGuidComb().
 *
 * @param l - The first GUID string to compare.
 * @param r - The second GUID string to compare.
 *
 * @public
 */
