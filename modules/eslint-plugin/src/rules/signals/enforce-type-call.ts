...
export const enforceTypeCallSuggest = 'enforceTypeCallSuggest';

type MessageIds = typeof enforceTypeCall | typeof enforceTypeCallSuggest;
...
export default createRule<Options, MessageIds>({
  ...
  meta: {
    ...
    messages: {
      ...
      [enforceTypeCallSuggest]: 'Add `()` to call the `{{name}}` function.',
    },
  },
  defaultOptions: [],
  create: (context) => {
