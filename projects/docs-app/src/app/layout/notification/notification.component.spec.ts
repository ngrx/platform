...
describe('NotificationComponent', () => {
  ...
  it('should call dismiss() when the message link is clicked, if dismissOnContentClick is true', () => {
    ...
    const message: HTMLSpanElement = fixture.debugElement.query(
  ...
  it('should update localStorage key when dismiss is called', () => {
    configTestingModule();
    createComponent();
    const setItemSpy: jasmine.Spy = TestBed.get(WindowToken).localStorage
      .setItem;
    component.dismiss();
    expect(setItemSpy).toHaveBeenCalledWith(
      'aio-notification/survey-january-2018',
      'hide'
    );
  });
  ...
  it('should not show the notification if the there is a "hide" flag in localStorage', () => {
    configTestingModule();
    const getItemSpy: jasmine.Spy = TestBed.get(WindowToken).localStorage
      .getItem;
