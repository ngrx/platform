...
@Component({
  template:
    '<aio-search-box (onSearch)="searchHandler($event)" (onFocus)="focusHandler($event)"></aio-search-box>',
})
class HostComponent {
...
describe('SearchBoxComponent', () => {
  ...
  beforeEach(() => {
    ...
    component = fixture.debugElement.query(By.directive(SearchBoxComponent))
      .componentInstance;
  ...
  describe('initialisation', () => {
    it(
      'should get the current search query from the location service',
      fakeAsync(
        inject([LocationService], (location: MockLocationService) => {
          ...
          expect(component.searchBox.nativeElement.value).toEqual(
            'initial search'
          );
        })
      )
  ...
  describe('onSearch', () => {
    ...
    it(
      'should pass through the value of the input box',
      fakeAsync(() => {
    ...
    it(
      'should only send events if the search value has changed',
      fakeAsync(() => {
        const input = fixture.debugElement.query(By.css('input'));
