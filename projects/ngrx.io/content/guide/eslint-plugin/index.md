...
| [@ngrx/signal-store-should-prefer-protected-state](/guide/eslint-plugin/rules/signal-store-should-prefer-protected-state)     | A Signal Store should prefer protected state.                                     | suggestion | No      | Yes             | No           | No                        |
