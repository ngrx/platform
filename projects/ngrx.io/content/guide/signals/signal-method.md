...
To prevent potential memory leaks, a warning is displayed if a method generated by `signalMethod` is called outside an injection context without a manually assigned injector.
